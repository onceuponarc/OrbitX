...
export const ACTION_META: Record<ActionKind, { label: string; body: string }> = {
  ...
  buyback: { label: "Buyback", body: "Buy the target token from the buyback vault." },
  burn: { label: "Burn", body: "Burn tokens from the burn vault." },
  buyback_burn: { label: "Buyback & burn", body: "Claim-eligible buyback funds, swap, then burn." },
  add_liquidity: { label: "Add liquidity", body: "Increase protocol-managed liquidity. Removal is not a feature." },
